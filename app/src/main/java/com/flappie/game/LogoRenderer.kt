...
class LogoRenderer(
    ...
    fun drawLogo(canvas: Canvas, centerX: Float, centerY: Float, @Suppress("UNUSED_PARAMETER") animationManager: AnimationManager? = null) {
        ...
        canvas.drawText("FLAPPIE", centerX, logoY, glowPaint)
        
        // Draw main title
        canvas.drawText("FLAPPIE", centerX, logoY, titlePaint)
    ...
    fun drawCompactLogo(canvas: Canvas, x: Float, y: Float, scale: Float = 1f) {
        ...
        canvas.drawText("FLAPPIE", x, y, compactGlowPaint)
        canvas.drawText("FLAPPIE", x, y, compactTitlePaint)
    }
