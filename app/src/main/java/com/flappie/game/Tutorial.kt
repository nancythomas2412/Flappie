...
object TutorialSteps {
    ...
    fun getAllSteps(): List<TutorialStep> = listOf(
        TutorialStep(
            id = 1,
            title = "Welcome to Flappie! 🐦",
            instruction = "Help Flappie fly through the pipes and collect coins!\n\nTap anywhere to continue",
        ...
        TutorialStep(
            id = 2, 
            title = "How to Fly",
            instruction = "TAP the screen to make Flappie jump up\n\nGravity will pull him down\n\nTry it now!",
            waitForAction = true,
