...
class StatisticsRenderer(
    ...
    fun drawStatisticsScreen(
        ...
        android.util.Log.e("GLACIER_DEBUG", "📐 RENDERER CALC: screen=${screenWidth}x$screenHeight, panel=${panelWidth}x$panelHeight at ($panelX,$panelY)")
        android.util.Log.e("GLACIER_DEBUG", "📐 RENDERER BUTTON: ($closeButtonX, $closeButtonY) size=${buttonSize}x$buttonSize")
