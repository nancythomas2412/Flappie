...
class GameView(context: Context) : SurfaceView(context), SurfaceHolder.Callback, GameUpdatable {
    ...
    override fun surfaceChanged(holder: SurfaceHolder, format: Int, width: Int, height: Int) {
        ...
        touchHandler = TouchHandler(screenWidth, screenHeight, achievementRenderer)
    ...
    private fun initializeGame() {
        ...
        touchHandler = TouchHandler(screenWidth.takeIf { it > 0 } ?: 1080, screenHeight.takeIf { it > 0 } ?: 1920, achievementRenderer)
